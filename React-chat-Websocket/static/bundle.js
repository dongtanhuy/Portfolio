...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chat = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				null,
				React.createElement(WelcomeView, { username: this.state.username, _onName: this._onName }),
				React.createElement(MainView, { username: this.state.username })
			);
		}
	});
	...
	var WelcomeView = React.createClass({
		...
		render: function render() {
			...
			return username ? React.createElement(
				'h1',
				null,
				'Welcome ',
				username
			) : React.createElement('input', { onKeyPress: this.props._onName, placeholder: 'Please enter your name' });
		}
	});
	...
	var MainView = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement('input', { placeholder: 'Type your message here', onKeyPress: this._onMessage })
			);
		}
	});
